...
const redirectUnauthorizedToPrivacy = () =>
    redirectUnauthorizedTo(['/privacy-sign-in']);
const redirectUnauthorizedToLegal = () =>
    redirectUnauthorizedTo(['/legal-notice-sign-in']);
...
export const routes: Routes = [
    ...
    {
        path: 'signup',
        component: SignupOverlayComponent,
        canActivate: [AuthGuard],
        data: { authGuardPipe: redirectLoggedInToItems },
    },
    {
    ...
    },
    {
        ...
        canActivate: [AuthGuard],
        data: { authGuardPipe: redirectUnauthorizedToPrivacy },
    },
    {
        path: 'help',
    ...
    },
    {
        ...
        canActivate: [AuthGuard],
        data: { authGuardPipe: redirectUnauthorizedToLegal },
    },
    {
        path: 'task',
        component: KanbanAddComponent,
        canActivate: [AuthGuard],
        data: { authGuardPipe: redirectUnauthorizedToLogIn },
    },
    {
    ...
    {
        path: 'privacy-sign-in',
        component: PrivacySignInComponent,
        canActivate: [AuthGuard],
        data: { authGuardPipe: redirectLoggedInToprivacy },
    },
    {
        path: 'legal-notice-sign-in',
        component: LegalNoticeSignInComponent,
        canActivate: [AuthGuard],
        data: { authGuardPipe: redirectLoggedInToLegal },
    },
];
